...
impl core::fmt::Debug for Const {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::MAX_LEGAL_KEY_CODE.0.into(),
                "MAX_LEGAL_KEY_CODE",
                "MaxLegalKeyCode",
            ),
            (
                Self::PER_KEY_BIT_ARRAY_SIZE.0.into(),
                "PER_KEY_BIT_ARRAY_SIZE",
                "PerKeyBitArraySize",
            ),
            (
                Self::KEY_NAME_LENGTH.0.into(),
                "KEY_NAME_LENGTH",
                "KeyNameLength",
            ),
        ];
...
impl core::fmt::Debug for EventType {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::NEW_KEYBOARD_NOTIFY.0.into(),
                "NEW_KEYBOARD_NOTIFY",
                "NewKeyboardNotify",
            ),
            ...
            (
                Self::CONTROLS_NOTIFY.0.into(),
                "CONTROLS_NOTIFY",
                "ControlsNotify",
            ),
            (
                Self::INDICATOR_STATE_NOTIFY.0.into(),
                "INDICATOR_STATE_NOTIFY",
                "IndicatorStateNotify",
            ),
            (
                Self::INDICATOR_MAP_NOTIFY.0.into(),
                "INDICATOR_MAP_NOTIFY",
                "IndicatorMapNotify",
            ),
            (Self::NAMES_NOTIFY.0.into(), "NAMES_NOTIFY", "NamesNotify"),
            (
                Self::COMPAT_MAP_NOTIFY.0.into(),
                "COMPAT_MAP_NOTIFY",
                "CompatMapNotify",
            ),
            (Self::BELL_NOTIFY.0.into(), "BELL_NOTIFY", "BellNotify"),
            (
                Self::ACTION_MESSAGE.0.into(),
                "ACTION_MESSAGE",
                "ActionMessage",
            ),
            (
                Self::ACCESS_X_NOTIFY.0.into(),
                "ACCESS_X_NOTIFY",
                "AccessXNotify",
            ),
            (
                Self::EXTENSION_DEVICE_NOTIFY.0.into(),
...
crate::bitmask_binop!(EventType, u16);
...
crate::bitmask_binop!(NKNDetail, u8);
...
crate::bitmask_binop!(AXNDetail, u8);
...
crate::bitmask_binop!(MapPart, u8);
...
crate::bitmask_binop!(SetMapFlags, u8);
...
impl core::fmt::Debug for StatePart {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::MODIFIER_STATE.0.into(),
                "MODIFIER_STATE",
                "ModifierState",
            ),
            (
                Self::MODIFIER_BASE.0.into(),
                "MODIFIER_BASE",
                "ModifierBase",
            ),
            (
                Self::MODIFIER_LATCH.0.into(),
                "MODIFIER_LATCH",
                "ModifierLatch",
            ),
            (
                Self::MODIFIER_LOCK.0.into(),
                "MODIFIER_LOCK",
                "ModifierLock",
            ),
            ...
            (
                Self::COMPAT_GRAB_MODS.0.into(),
                "COMPAT_GRAB_MODS",
                "CompatGrabMods",
            ),
            (Self::LOOKUP_MODS.0.into(), "LOOKUP_MODS", "LookupMods"),
            (
                Self::COMPAT_LOOKUP_MODS.0.into(),
                "COMPAT_LOOKUP_MODS",
                "CompatLookupMods",
            ),
            (
                Self::POINTER_BUTTONS.0.into(),
                "POINTER_BUTTONS",
                "PointerButtons",
            ),
        ];
...
crate::bitmask_binop!(StatePart, u16);
...
impl core::fmt::Debug for BoolCtrl {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::MOUSE_KEYS_ACCEL.0.into(),
                "MOUSE_KEYS_ACCEL",
                "MouseKeysAccel",
            ),
            (Self::ACCESS_X_KEYS.0.into(), "ACCESS_X_KEYS", "AccessXKeys"),
            (
                Self::ACCESS_X_TIMEOUT_MASK.0.into(),
                "ACCESS_X_TIMEOUT_MASK",
                "AccessXTimeoutMask",
            ),
            (
                Self::ACCESS_X_FEEDBACK_MASK.0.into(),
                "ACCESS_X_FEEDBACK_MASK",
                "AccessXFeedbackMask",
            ),
            (
                Self::AUDIBLE_BELL_MASK.0.into(),
                "AUDIBLE_BELL_MASK",
                "AudibleBellMask",
            ),
            (
                Self::OVERLAY1_MASK.0.into(),
                "OVERLAY1_MASK",
                "Overlay1Mask",
            ),
            (
                Self::OVERLAY2_MASK.0.into(),
                "OVERLAY2_MASK",
                "Overlay2Mask",
            ),
            (
                Self::IGNORE_GROUP_LOCK_MASK.0.into(),
...
crate::bitmask_binop!(BoolCtrl, u16);
...
crate::bitmask_binop!(Control, u32);
...
crate::bitmask_binop!(AXOption, u16);
...
impl core::fmt::Debug for LedClassResult {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::KBD_FEEDBACK_CLASS.0.into(),
                "KBD_FEEDBACK_CLASS",
                "KbdFeedbackClass",
            ),
            (
                Self::LED_FEEDBACK_CLASS.0.into(),
                "LED_FEEDBACK_CLASS",
                "LedFeedbackClass",
            ),
        ];
...
impl core::fmt::Debug for BellClassResult {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::BELL_FEEDBACK_CLASS.0.into(),
                "BELL_FEEDBACK_CLASS",
                "BellFeedbackClass",
            ),
        ];
...
crate::bitmask_binop!(SetOfGroup, u8);
...
impl core::fmt::Debug for SetOfGroups {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [(Self::ANY.0.into(), "ANY", "Any")];
        pretty_print_bitmask(fmt, self.0.into(), &variants)
    }
}
crate::bitmask_binop!(SetOfGroups, u8);
...
impl core::fmt::Debug for GroupsWrap {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::WRAP_INTO_RANGE.0.into(),
                "WRAP_INTO_RANGE",
                "WrapIntoRange",
            ),
            (
                Self::CLAMP_INTO_RANGE.0.into(),
                "CLAMP_INTO_RANGE",
                "ClampIntoRange",
            ),
            (
                Self::REDIRECT_INTO_RANGE.0.into(),
                "REDIRECT_INTO_RANGE",
                "RedirectIntoRange",
            ),
        ];
...
crate::bitmask_binop!(GroupsWrap, u8);
...
crate::bitmask_binop!(VModsHigh, u8);
...
crate::bitmask_binop!(VModsLow, u8);
...
crate::bitmask_binop!(Explicit, u8);
...
crate::bitmask_binop!(IMModsWhich, u8);
...
crate::bitmask_binop!(IMGroupsWhich, u8);
...
crate::bitmask_binop!(CMDetail, u8);
...
impl core::fmt::Debug for NameDetail {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::KEY_TYPE_NAMES.0.into(),
                "KEY_TYPE_NAMES",
                "KeyTypeNames",
            ),
            (
                Self::KT_LEVEL_NAMES.0.into(),
                "KT_LEVEL_NAMES",
                "KTLevelNames",
            ),
            (
                Self::INDICATOR_NAMES.0.into(),
                "INDICATOR_NAMES",
                "IndicatorNames",
            ),
...
crate::bitmask_binop!(NameDetail, u16);
...
impl core::fmt::Debug for GBNDetail {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::CLIENT_SYMBOLS.0.into(),
                "CLIENT_SYMBOLS",
                "ClientSymbols",
            ),
            (
                Self::SERVER_SYMBOLS.0.into(),
                "SERVER_SYMBOLS",
                "ServerSymbols",
            ),
            (
                Self::INDICATOR_MAPS.0.into(),
                "INDICATOR_MAPS",
                "IndicatorMaps",
            ),
            (Self::KEY_NAMES.0.into(), "KEY_NAMES", "KeyNames"),
...
crate::bitmask_binop!(GBNDetail, u8);
...
crate::bitmask_binop!(XIFeature, u8);
...
impl core::fmt::Debug for PerClientFlag {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::DETECTABLE_AUTO_REPEAT.0.into(),
                "DETECTABLE_AUTO_REPEAT",
                "DetectableAutoRepeat",
            ),
            (
                Self::GRABS_USE_XKB_STATE.0.into(),
                "GRABS_USE_XKB_STATE",
                "GrabsUseXKBState",
            ),
            (
                Self::AUTO_RESET_CONTROLS.0.into(),
                "AUTO_RESET_CONTROLS",
                "AutoResetControls",
            ),
            (
                Self::LOOKUP_STATE_WHEN_GRABBED.0.into(),
                "LOOKUP_STATE_WHEN_GRABBED",
                "LookupStateWhenGrabbed",
            ),
            (
                Self::SEND_EVENT_USES_XKB_STATE.0.into(),
...
crate::bitmask_binop!(PerClientFlag, u8);
...
impl TryParse for CountedString16 {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (string, remaining) =
            crate::x11_utils::parse_u8_list(remaining, length.try_to_usize()?)?;
        let string = string.to_vec();
        let (alignment_pad, remaining) = crate::x11_utils::parse_u8_list(
            remaining,
            (u32::from(length)
                .checked_add(5u32)
...
impl Serialize for CountedString16 {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        debug_assert_eq!(
            self.alignment_pad.len(),
            usize::try_from(
                (u32::from(length).checked_add(5u32).unwrap() & (!3u32))
                    .checked_sub(u32::from(length).checked_add(2u32).unwrap())
                    .unwrap()
            )
            .unwrap(),
            "`alignment_pad` has an incorrect length"
        );
...
impl TryParse for KeyType {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (map, remaining) =
            crate::x11_utils::parse_list::<KTMapEntry>(remaining, n_map_entries.try_to_usize()?)?;
        let (preserve, remaining) = crate::x11_utils::parse_list::<ModDef>(
            remaining,
            u32::from(has_preserve)
                .checked_mul(u32::from(n_map_entries))
                .ok_or(ParseError::InvalidExpression)?
                .try_to_usize()?,
        )?;
        let result = KeyType {
...
impl Serialize for KeyType {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        debug_assert_eq!(
            self.preserve.len(),
            usize::try_from(
                u32::from(self.has_preserve)
                    .checked_mul(u32::from(n_map_entries))
                    .unwrap()
            )
            .unwrap(),
            "`preserve` has an incorrect length"
        );
...
impl TryParse for KeySymMap {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (syms, remaining) =
            crate::x11_utils::parse_list::<xproto::Keysym>(remaining, n_syms.try_to_usize()?)?;
        let result = KeySymMap {
            kt_index,
            group_info,
            width,
            syms,
...
impl Behavior {
    ...
    pub fn as_permament_radio_group(&self) -> PermamentRadioGroupBehavior {
        fn do_the_parse(remaining: &[u8]) -> Result<PermamentRadioGroupBehavior, ParseError> {
            let (permament_radio_group, remaining) =
                PermamentRadioGroupBehavior::try_parse(remaining)?;
            let _ = remaining;
...
impl core::fmt::Debug for BehaviorType {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::PERMAMENT_LOCK.0.into(),
                "PERMAMENT_LOCK",
                "PermamentLock",
            ),
            (
                Self::PERMAMENT_RADIO_GROUP.0.into(),
                "PERMAMENT_RADIO_GROUP",
                "PermamentRadioGroup",
            ),
            (
                Self::PERMAMENT_OVERLAY1.0.into(),
                "PERMAMENT_OVERLAY1",
                "PermamentOverlay1",
            ),
            (
                Self::PERMAMENT_OVERLAY2.0.into(),
                "PERMAMENT_OVERLAY2",
                "PermamentOverlay2",
            ),
        ];
...
impl Serialize for SetExplicit {
    ...
    fn serialize(&self) -> [u8; 2] {
        ...
        [keycode_bytes[0], explicit_bytes[0]]
    }
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        bytes.reserve(2);
        self.keycode.serialize_into(bytes);
...
impl TryParse for SetKeyType {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(1..).ok_or(ParseError::InsufficientData)?;
        let (entries, remaining) = crate::x11_utils::parse_list::<KTSetMapEntry>(
            remaining,
            n_map_entries.try_to_usize()?,
        )?;
        let (preserve_entries, remaining) = crate::x11_utils::parse_list::<KTSetMapEntry>(
            remaining,
            u32::from(preserve)
                .checked_mul(u32::from(n_map_entries))
                .ok_or(ParseError::InvalidExpression)?
...
impl Serialize for SetKeyType {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        self.num_levels.serialize_into(bytes);
        let n_map_entries =
            u8::try_from(self.entries.len()).expect("`entries` has too many elements");
        n_map_entries.serialize_into(bytes);
        self.preserve.serialize_into(bytes);
        bytes.extend_from_slice(&[0; 1]);
        self.entries.serialize_into(bytes);
        debug_assert_eq!(
            self.preserve_entries.len(),
            usize::try_from(
                u32::from(self.preserve)
                    .checked_mul(u32::from(n_map_entries))
                    .unwrap()
            )
            .unwrap(),
            "`preserve_entries` has an incorrect length"
        );
...
impl TryParse for Outline {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (points, remaining) =
            crate::x11_utils::parse_list::<xproto::Point>(remaining, n_points.try_to_usize()?)?;
        let result = Outline {
            corner_radius,
            points,
        };
...
impl TryParse for Shape {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(1..).ok_or(ParseError::InsufficientData)?;
        let (outlines, remaining) =
            crate::x11_utils::parse_list::<Outline>(remaining, n_outlines.try_to_usize()?)?;
        let result = Shape {
            name,
            primary_ndx,
            approx_ndx,
...
impl Serialize for Shape {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        let n_outlines =
            u8::try_from(self.outlines.len()).expect("`outlines` has too many elements");
...
impl Shape {
    ...
    pub fn n_outlines(&self) -> u8 {
        self.outlines.len().try_into().unwrap()
    }
}
...
impl TryParse for OverlayRow {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(2..).ok_or(ParseError::InsufficientData)?;
        let (keys, remaining) =
            crate::x11_utils::parse_list::<OverlayKey>(remaining, n_keys.try_to_usize()?)?;
...
impl TryParse for Overlay {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (rows, remaining) =
            crate::x11_utils::parse_list::<OverlayRow>(remaining, n_rows.try_to_usize()?)?;
...
impl TryParse for Row {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(2..).ok_or(ParseError::InsufficientData)?;
        let (keys, remaining) =
            crate::x11_utils::parse_list::<Key>(remaining, n_keys.try_to_usize()?)?;
        let result = Row {
            top,
            left,
            vertical,
...
impl TryParse for DeviceLedInfo {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (names, remaining) = crate::x11_utils::parse_list::<xproto::Atom>(
            remaining,
            names_present.count_ones().try_to_usize()?,
        )?;
        let (maps, remaining) = crate::x11_utils::parse_list::<IndicatorMap>(
            remaining,
            maps_present.count_ones().try_to_usize()?,
        )?;
        let led_class = led_class.into();
        let result = DeviceLedInfo {
            led_class,
            led_id,
            names_present,
            maps_present,
...
impl Serialize for DeviceLedInfo {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        debug_assert_eq!(
            self.names.len(),
            usize::try_from(self.names_present.count_ones()).unwrap(),
            "`names` has an incorrect length"
        );
        self.names.serialize_into(bytes);
        debug_assert_eq!(
            self.maps.len(),
            usize::try_from(self.maps_present.count_ones()).unwrap(),
            "`maps` has an incorrect length"
        );
...
impl core::fmt::Debug for SA {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (Self::LATCH_TO_LOCK.0.into(), "LATCH_TO_LOCK", "LatchToLock"),
            (
                Self::USE_MOD_MAP_MODS.0.into(),
                "USE_MOD_MAP_MODS",
                "UseModMapMods",
            ),
            (
                Self::GROUP_ABSOLUTE.0.into(),
                "GROUP_ABSOLUTE",
                "GroupAbsolute",
            ),
        ];
...
impl core::fmt::Debug for SAType {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::SWITCH_SCREEN.0.into(),
                "SWITCH_SCREEN",
                "SwitchScreen",
            ),
            (Self::SET_CONTROLS.0.into(), "SET_CONTROLS", "SetControls"),
            (
                Self::LOCK_CONTROLS.0.into(),
                "LOCK_CONTROLS",
                "LockControls",
            ),
            (
            ...
            (
                Self::LOCK_DEVICE_BTN.0.into(),
                "LOCK_DEVICE_BTN",
                "LockDeviceBtn",
            ),
            (
                Self::DEVICE_VALUATOR.0.into(),
                "DEVICE_VALUATOR",
                "DeviceValuator",
            ),
        ];
...
impl Serialize for SASetGroup {
    ...
    fn serialize(&self) -> [u8; 8] {
        ...
        let flags_bytes = self.flags.serialize();
        let group_bytes = self.group.serialize();
        [type_bytes[0], flags_bytes[0], group_bytes[0], 0, 0, 0, 0, 0]
    }
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        bytes.reserve(8);
        u8::from(self.type_).serialize_into(bytes);
...
impl core::fmt::Debug for SAMovePtrFlag {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::NO_ACCELERATION.0.into(),
                "NO_ACCELERATION",
                "NoAcceleration",
            ),
            (
                Self::MOVE_ABSOLUTE_X.0.into(),
                "MOVE_ABSOLUTE_X",
                "MoveAbsoluteX",
            ),
            (
                Self::MOVE_ABSOLUTE_Y.0.into(),
                "MOVE_ABSOLUTE_Y",
                "MoveAbsoluteY",
            ),
        ];
...
crate::bitmask_binop!(SAMovePtrFlag, u8);
...
impl core::fmt::Debug for SASetPtrDfltFlag {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::DFLT_BTN_ABSOLUTE.0.into(),
                "DFLT_BTN_ABSOLUTE",
                "DfltBtnAbsolute",
            ),
            (
                Self::AFFECT_DFLT_BUTTON.0.into(),
                "AFFECT_DFLT_BUTTON",
                "AffectDfltButton",
            ),
        ];
...
crate::bitmask_binop!(SASetPtrDfltFlag, u8);
...
crate::bitmask_binop!(SAIsoLockFlag, u8);
...
crate::bitmask_binop!(SAIsoLockNoAffect, u8);
...
crate::bitmask_binop!(SwitchScreenFlag, u8);
...
crate::bitmask_binop!(BoolCtrlsHigh, u8);
...
crate::bitmask_binop!(BoolCtrlsLow, u8);
...
crate::bitmask_binop!(ActionMessageFlag, u8);
...
crate::bitmask_binop!(LockDeviceFlags, u8);
...
impl core::fmt::Debug for SAValWhat {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::SET_VAL_CENTER.0.into(),
                "SET_VAL_CENTER",
                "SetValCenter",
            ),
            (Self::SET_VAL_MAX.0.into(), "SET_VAL_MAX", "SetValMax"),
            (
                Self::SET_VAL_RELATIVE.0.into(),
                "SET_VAL_RELATIVE",
                "SetValRelative",
            ),
            (
                Self::SET_VAL_ABSOLUTE.0.into(),
                "SET_VAL_ABSOLUTE",
                "SetValAbsolute",
            ),
        ];
...
impl From<SAType> for Action {
    fn from(type_: SAType) -> Self {
        ...
        let value = [type_bytes[0], 0, 0, 0, 0, 0, 0, 0];
        Self(value)
    }
}
...
impl Serialize for SelectEventsAuxBitcase7 {
    ...
    fn serialize(&self) -> [u8; 2] {
        ...
        [affect_compat_bytes[0], compat_details_bytes[0]]
    }
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        bytes.reserve(2);
...
impl Serialize for SelectEventsAuxBitcase8 {
    ...
    fn serialize(&self) -> [u8; 2] {
        ...
        [affect_bell_bytes[0], bell_details_bytes[0]]
    }
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        bytes.reserve(2);
...
impl Serialize for SelectEventsAuxBitcase9 {
    ...
    fn serialize(&self) -> [u8; 2] {
        ...
        [affect_msg_details_bytes[0], msg_details_bytes[0]]
    }
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        bytes.reserve(2);
...
impl SelectEventsAux {
    #[allow(dead_code)]
    fn serialize(&self, affect_which: u16, clear: u16, select_all: u16) -> impl AsRef<[u8]> {
        let mut result = Vec::new();
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>, affect_which: u16, clear: u16, select_all: u16) {
        debug_assert_eq!(
            ...
            "switch `details` has an inconsistent discriminant"
        );
...
impl SelectEventsAux {
    ...
    #[must_use]
    pub fn bitcase1<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase1>>,
    {
    ...
    #[must_use]
    pub fn bitcase2<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase2>>,
    {
    ...
    #[must_use]
    pub fn bitcase3<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase3>>,
    {
    ...
    #[must_use]
    pub fn bitcase4<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase4>>,
    {
    ...
    #[must_use]
    pub fn bitcase5<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase5>>,
    {
    ...
    #[must_use]
    pub fn bitcase6<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase6>>,
    {
    ...
    #[must_use]
    pub fn bitcase7<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase7>>,
    {
    ...
    #[must_use]
    pub fn bitcase8<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase8>>,
    {
    ...
    #[must_use]
    pub fn bitcase9<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase9>>,
    {
    ...
    #[must_use]
    pub fn bitcase10<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase10>>,
    {
    ...
    #[must_use]
    pub fn bitcase11<I>(mut self, value: I) -> Self
    where
        I: Into<Option<SelectEventsAuxBitcase11>>,
    {
...
impl<'input> SelectEventsRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let details_bytes = self
            .details
            .serialize(affect_which, self.clear, self.select_all);
        let referenced: &[u8] = details_bytes.as_ref();
        ...
        request0.extend_from_slice(details_bytes.as_ref());
...
impl<'input> SetControlsRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let affect_ignore_lock_virtual_mods_bytes =
            self.affect_ignore_lock_virtual_mods.serialize();
        ...
        let access_x_timeout_options_values_bytes =
            self.access_x_timeout_options_values.serialize();
        let per_key_repeat_bytes = self.per_key_repeat.as_ref();
        let mut request0 = [
            major_opcode,
            ...
            per_key_repeat_bytes[0],
            per_key_repeat_bytes[1],
            per_key_repeat_bytes[2],
            per_key_repeat_bytes[3],
            per_key_repeat_bytes[4],
            per_key_repeat_bytes[5],
            per_key_repeat_bytes[6],
            per_key_repeat_bytes[7],
            per_key_repeat_bytes[8],
            per_key_repeat_bytes[9],
            per_key_repeat_bytes[10],
            per_key_repeat_bytes[11],
            per_key_repeat_bytes[12],
            per_key_repeat_bytes[13],
            per_key_repeat_bytes[14],
            per_key_repeat_bytes[15],
            per_key_repeat_bytes[16],
            per_key_repeat_bytes[17],
            per_key_repeat_bytes[18],
            per_key_repeat_bytes[19],
            per_key_repeat_bytes[20],
            per_key_repeat_bytes[21],
            per_key_repeat_bytes[22],
            per_key_repeat_bytes[23],
            per_key_repeat_bytes[24],
            per_key_repeat_bytes[25],
            per_key_repeat_bytes[26],
            per_key_repeat_bytes[27],
            per_key_repeat_bytes[28],
            per_key_repeat_bytes[29],
            per_key_repeat_bytes[30],
            per_key_repeat_bytes[31],
        ];
        request0[2..4].copy_from_slice(&(25u16).to_ne_bytes());
        request0
    }
}
...
impl GetMapMapBitcase3 {
    pub fn try_parse(
        ...
        let value = remaining;
        let (acts_rtrn_count, remaining) =
            crate::x11_utils::parse_u8_list(remaining, n_key_actions.try_to_usize()?)?;
        ...
        let remaining = remaining
            .get(misalignment..)
            .ok_or(ParseError::InsufficientData)?;
        let (acts_rtrn_acts, remaining) =
            crate::x11_utils::parse_list::<Action>(remaining, total_actions.try_to_usize()?)?;
        let result = GetMapMapBitcase3 {
            acts_rtrn_count,
            acts_rtrn_acts,
        };
        Ok((result, remaining))
...
impl GetMapMap {
    fn try_parse(
        ...
        let types_rtrn = if switch_expr & u16::from(MapPart::KEY_TYPES) != 0 {
            ...
            let (types_rtrn, remaining) =
                crate::x11_utils::parse_list::<KeyType>(remaining, n_types.try_to_usize()?)?;
        ...
        let syms_rtrn = if switch_expr & u16::from(MapPart::KEY_SYMS) != 0 {
            let remaining = outer_remaining;
            let (syms_rtrn, remaining) =
                crate::x11_utils::parse_list::<KeySymMap>(remaining, n_key_syms.try_to_usize()?)?;
            outer_remaining = remaining;
            Some(syms_rtrn)
        } else {
            None
        ...
        let bitcase3 = if switch_expr & u16::from(MapPart::KEY_ACTIONS) != 0 {
            let (bitcase3, new_remaining) =
                GetMapMapBitcase3::try_parse(outer_remaining, n_key_actions, total_actions)?;
        ...
        let behaviors_rtrn = if switch_expr & u16::from(MapPart::KEY_BEHAVIORS) != 0 {
            let remaining = outer_remaining;
            let (behaviors_rtrn, remaining) = crate::x11_utils::parse_list::<SetBehavior>(
                remaining,
                total_key_behaviors.try_to_usize()?,
            )?;
            outer_remaining = remaining;
            Some(behaviors_rtrn)
        } else {
        ...
        let vmods_rtrn = if switch_expr & u16::from(MapPart::VIRTUAL_MODS) != 0 {
            let remaining = outer_remaining;
            let value = remaining;
            let (vmods_rtrn, remaining) = crate::x11_utils::parse_u8_list(
                remaining,
                virtual_mods.count_ones().try_to_usize()?,
            )?;
        ...
        let explicit_rtrn = if switch_expr & u16::from(MapPart::EXPLICIT_COMPONENTS) != 0 {
            let remaining = outer_remaining;
            let value = remaining;
            let (explicit_rtrn, remaining) = crate::x11_utils::parse_list::<SetExplicit>(
                remaining,
                total_key_explicit.try_to_usize()?,
            )?;
            // Align offset to multiple of 4
            let offset = remaining.as_ptr() as usize - value.as_ptr() as usize;
            let misalignment = (4 - (offset % 4)) % 4;
        ...
        let modmap_rtrn = if switch_expr & u16::from(MapPart::MODIFIER_MAP) != 0 {
            let remaining = outer_remaining;
            let value = remaining;
            let (modmap_rtrn, remaining) = crate::x11_utils::parse_list::<KeyModMap>(
                remaining,
                total_mod_map_keys.try_to_usize()?,
            )?;
            // Align offset to multiple of 4
            let offset = remaining.as_ptr() as usize - value.as_ptr() as usize;
            let misalignment = (4 - (offset % 4)) % 4;
        ...
        let vmodmap_rtrn = if switch_expr & u16::from(MapPart::VIRTUAL_MOD_MAP) != 0 {
            let remaining = outer_remaining;
            let (vmodmap_rtrn, remaining) = crate::x11_utils::parse_list::<KeyVModMap>(
                remaining,
                total_v_mod_map_keys.try_to_usize()?,
            )?;
            outer_remaining = remaining;
            Some(vmodmap_rtrn)
        } else {
...
impl TryParse for GetMapReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(1..).ok_or(ParseError::InsufficientData)?;
        let (virtual_mods, remaining) = u16::try_parse(remaining)?;
        let (map, remaining) = GetMapMap::try_parse(
            remaining,
            present,
            n_types,
            n_key_syms,
...
impl SetMapAuxBitcase3 {
    #[allow(dead_code)]
    fn serialize(&self, n_key_actions: u8, total_actions: u16) -> impl AsRef<[u8]> {
        let mut result = Vec::new();
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>, n_key_actions: u8, total_actions: u16) {
        debug_assert_eq!(
            self.actions_count.len(),
            usize::try_from(n_key_actions).unwrap(),
            "`actions_count` has an incorrect length"
        );
        bytes.extend_from_slice(&self.actions_count);
        bytes.extend_from_slice(&[0; 3][..(4 - (bytes.len() % 4)) % 4]);
        debug_assert_eq!(
            self.actions.len(),
            usize::try_from(total_actions).unwrap(),
            "`actions` has an incorrect length"
        );
...
impl SetMapAux {
    ...
    fn serialize_into(
        ...
        debug_assert_eq!(
            self.switch_expr(),
            present,
            "switch `values` has an inconsistent discriminant"
        );
        if let Some(ref types) = self.types {
            debug_assert_eq!(
                types.len(),
                usize::try_from(n_types).unwrap(),
                "`types` has an incorrect length"
            );
        ...
        if let Some(ref syms) = self.syms {
            debug_assert_eq!(
                syms.len(),
                usize::try_from(n_key_syms).unwrap(),
                "`syms` has an incorrect length"
            );
        ...
        if let Some(ref behaviors) = self.behaviors {
            debug_assert_eq!(
                behaviors.len(),
                usize::try_from(total_key_behaviors).unwrap(),
                "`behaviors` has an incorrect length"
            );
        ...
        if let Some(ref vmods) = self.vmods {
            debug_assert_eq!(
                vmods.len(),
                usize::try_from(virtual_mods.count_ones()).unwrap(),
                "`vmods` has an incorrect length"
            );
        ...
        if let Some(ref explicit) = self.explicit {
            debug_assert_eq!(
                explicit.len(),
                usize::try_from(total_key_explicit).unwrap(),
                "`explicit` has an incorrect length"
            );
        ...
        if let Some(ref modmap) = self.modmap {
            debug_assert_eq!(
                modmap.len(),
                usize::try_from(total_mod_map_keys).unwrap(),
                "`modmap` has an incorrect length"
            );
        ...
        if let Some(ref vmodmap) = self.vmodmap {
            debug_assert_eq!(
                vmodmap.len(),
                usize::try_from(total_v_mod_map_keys).unwrap(),
                "`vmodmap` has an incorrect length"
            );
...
impl SetMapAux {
    ...
    #[must_use]
    pub fn types<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn syms<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn behaviors<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn vmods<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn explicit<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn modmap<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<KeyModMap>>>,
    {
    ...
    #[must_use]
    pub fn vmodmap<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<KeyVModMap>>>,
    {
...
impl TryParse for GetCompatMapReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (si_rtrn, remaining) =
            crate::x11_utils::parse_list::<SymInterpret>(remaining, n_si_rtrn.try_to_usize()?)?;
        let (group_rtrn, remaining) = crate::x11_utils::parse_list::<ModDef>(
            remaining,
            groups_rtrn.count_ones().try_to_usize()?,
        )?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetCompatMapReply {
            device_id,
            sequence,
            length,
            groups_rtrn,
...
impl GetCompatMapReply {
    ...
    pub fn n_si_rtrn(&self) -> u16 {
        self.si_rtrn.len().try_into().unwrap()
    }
}
...
impl<'input> SetCompatMapRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = si_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        debug_assert_eq!(
            self.group_maps.len(),
            usize::try_from(self.groups.count_ones()).unwrap(),
            "`group_maps` has an incorrect length"
        );
        let group_maps_bytes = self.group_maps.serialize();
        let referenced: &[u8] = group_maps_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(si_bytes.as_ref());
        request0.extend_from_slice(group_maps_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for GetIndicatorStateReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetIndicatorStateReply {
            device_id,
            sequence,
            length,
            state,
...
impl TryParse for GetIndicatorMapReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (maps, remaining) = crate::x11_utils::parse_list::<IndicatorMap>(
            remaining,
            which.count_ones().try_to_usize()?,
        )?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetIndicatorMapReply {
            device_id,
            sequence,
            length,
            which,
...
impl<'input> SetIndicatorMapRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        debug_assert_eq!(
            self.maps.len(),
            usize::try_from(self.which.count_ones()).unwrap(),
            "`maps` has an incorrect length"
        );
        let maps_bytes = self.maps.serialize();
        let referenced: &[u8] = maps_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(maps_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl GetNamesValueListBitcase8 {
    pub fn try_parse(remaining: &[u8], n_types: u8) -> Result<(Self, &[u8]), ParseError> {
        let value = remaining;
        let (n_levels_per_type, remaining) =
            crate::x11_utils::parse_u8_list(remaining, n_types.try_to_usize()?)?;
        ...
        let remaining = remaining
            .get(misalignment..)
            .ok_or(ParseError::InsufficientData)?;
        let (kt_level_names, remaining) = crate::x11_utils::parse_list::<xproto::Atom>(
            remaining,
            n_levels_per_type
                .iter()
                .try_fold(0u32, |acc, x| {
                    acc.checked_add(u32::from(*x))
                        .ok_or(ParseError::InvalidExpression)
                })?
                .try_to_usize()?,
        )?;
        let result = GetNamesValueListBitcase8 {
            n_levels_per_type,
            kt_level_names,
        };
        Ok((result, remaining))
...
impl GetNamesValueList {
    fn try_parse(
        ...
        let type_names = if switch_expr & u32::from(NameDetail::KEY_TYPE_NAMES) != 0 {
            let remaining = outer_remaining;
            let (type_names, remaining) =
                crate::x11_utils::parse_list::<xproto::Atom>(remaining, n_types.try_to_usize()?)?;
            outer_remaining = remaining;
            Some(type_names)
        } else {
            None
        ...
        let bitcase8 = if switch_expr & u32::from(NameDetail::KT_LEVEL_NAMES) != 0 {
            let (bitcase8, new_remaining) =
                GetNamesValueListBitcase8::try_parse(outer_remaining, n_types)?;
            outer_remaining = new_remaining;
            Some(bitcase8)
        } else {
            None
        ...
        let indicator_names = if switch_expr & u32::from(NameDetail::INDICATOR_NAMES) != 0 {
            let remaining = outer_remaining;
            let (indicator_names, remaining) = crate::x11_utils::parse_list::<xproto::Atom>(
                remaining,
                indicators.count_ones().try_to_usize()?,
            )?;
            outer_remaining = remaining;
        ...
        let virtual_mod_names = if switch_expr & u32::from(NameDetail::VIRTUAL_MOD_NAMES) != 0 {
            let remaining = outer_remaining;
            let (virtual_mod_names, remaining) = crate::x11_utils::parse_list::<xproto::Atom>(
                remaining,
                virtual_mods.count_ones().try_to_usize()?,
            )?;
            outer_remaining = remaining;
        ...
        let groups = if switch_expr & u32::from(NameDetail::GROUP_NAMES) != 0 {
            let remaining = outer_remaining;
            let (groups, remaining) = crate::x11_utils::parse_list::<xproto::Atom>(
                remaining,
                group_names.count_ones().try_to_usize()?,
            )?;
            outer_remaining = remaining;
            Some(groups)
        } else {
        ...
        let key_names = if switch_expr & u32::from(NameDetail::KEY_NAMES) != 0 {
            let remaining = outer_remaining;
            let (key_names, remaining) =
                crate::x11_utils::parse_list::<KeyName>(remaining, n_keys.try_to_usize()?)?;
            outer_remaining = remaining;
            Some(key_names)
        } else {
            None
        ...
        let key_aliases = if switch_expr & u32::from(NameDetail::KEY_ALIASES) != 0 {
            let remaining = outer_remaining;
            let (key_aliases, remaining) =
                crate::x11_utils::parse_list::<KeyAlias>(remaining, n_key_aliases.try_to_usize()?)?;
            outer_remaining = remaining;
            Some(key_aliases)
        } else {
            None
        ...
        let radio_group_names = if switch_expr & u32::from(NameDetail::RG_NAMES) != 0 {
            let remaining = outer_remaining;
            let (radio_group_names, remaining) = crate::x11_utils::parse_list::<xproto::Atom>(
                remaining,
                n_radio_groups.try_to_usize()?,
            )?;
            outer_remaining = remaining;
...
impl TryParse for GetNamesReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(4..).ok_or(ParseError::InsufficientData)?;
        let (value_list, remaining) = GetNamesValueList::try_parse(
            remaining,
            which,
            n_types,
            indicators,
...
impl SetNamesAuxBitcase8 {
    #[allow(dead_code)]
    fn serialize(&self, n_types: u8) -> impl AsRef<[u8]> {
        let mut result = Vec::new();
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>, n_types: u8) {
        debug_assert_eq!(
            self.n_levels_per_type.len(),
            usize::try_from(n_types).unwrap(),
            "`n_levels_per_type` has an incorrect length"
        );
        bytes.extend_from_slice(&self.n_levels_per_type);
        bytes.extend_from_slice(&[0; 3][..(4 - (bytes.len() % 4)) % 4]);
        debug_assert_eq!(
            self.kt_level_names.len(),
            usize::try_from(
                self.n_levels_per_type
                    .iter()
                    .fold(0u32, |acc, x| acc.checked_add(u32::from(*x)).unwrap())
            )
            .unwrap(),
            "`kt_level_names` has an incorrect length"
        );
    ...
    fn serialize_into(
        ...
        if let Some(ref type_names) = self.type_names {
            debug_assert_eq!(
                type_names.len(),
                usize::try_from(n_types).unwrap(),
                "`type_names` has an incorrect length"
            );
        ...
        if let Some(ref indicator_names) = self.indicator_names {
            debug_assert_eq!(
                indicator_names.len(),
                usize::try_from(indicators.count_ones()).unwrap(),
                "`indicator_names` has an incorrect length"
            );
            indicator_names.serialize_into(bytes);
        }
        if let Some(ref virtual_mod_names) = self.virtual_mod_names {
            debug_assert_eq!(
                virtual_mod_names.len(),
                usize::try_from(virtual_mods.count_ones()).unwrap(),
                "`virtual_mod_names` has an incorrect length"
            );
        ...
        if let Some(ref groups) = self.groups {
            debug_assert_eq!(
                groups.len(),
                usize::try_from(group_names.count_ones()).unwrap(),
                "`groups` has an incorrect length"
            );
        ...
        if let Some(ref key_names) = self.key_names {
            debug_assert_eq!(
                key_names.len(),
                usize::try_from(n_keys).unwrap(),
                "`key_names` has an incorrect length"
            );
        ...
        if let Some(ref key_aliases) = self.key_aliases {
            debug_assert_eq!(
                key_aliases.len(),
                usize::try_from(n_key_aliases).unwrap(),
                "`key_aliases` has an incorrect length"
            );
            key_aliases.serialize_into(bytes);
        }
        if let Some(ref radio_group_names) = self.radio_group_names {
            debug_assert_eq!(
                radio_group_names.len(),
                usize::try_from(n_radio_groups).unwrap(),
                "`radio_group_names` has an incorrect length"
            );
...
impl SetNamesAux {
    ...
    #[must_use]
    pub fn keycodes_name<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn geometry_name<I>(mut self, value: I) -> Self
    where
        I: Into<Option<xproto::Atom>>,
    {
    ...
    #[must_use]
    pub fn symbols_name<I>(mut self, value: I) -> Self
    where
        I: Into<Option<xproto::Atom>>,
    {
    ...
    #[must_use]
    pub fn phys_symbols_name<I>(mut self, value: I) -> Self
    where
        I: Into<Option<xproto::Atom>>,
    {
    ...
    #[must_use]
    pub fn types_name<I>(mut self, value: I) -> Self
    where
        I: Into<Option<xproto::Atom>>,
    {
    ...
    #[must_use]
    pub fn compat_name<I>(mut self, value: I) -> Self
    where
        I: Into<Option<xproto::Atom>>,
    {
    ...
    #[must_use]
    pub fn type_names<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<xproto::Atom>>>,
    {
    ...
    #[must_use]
    pub fn indicator_names<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<xproto::Atom>>>,
    {
    ...
    #[must_use]
    pub fn virtual_mod_names<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<xproto::Atom>>>,
    {
    ...
    #[must_use]
    pub fn key_names<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<KeyName>>>,
    {
    ...
    #[must_use]
    pub fn key_aliases<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<KeyAlias>>>,
    {
    ...
    #[must_use]
    pub fn radio_group_names<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Vec<xproto::Atom>>>,
    {
...
impl TryParse for PerClientFlagsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PerClientFlagsReply {
            device_id,
            sequence,
            length,
            supported,
...
impl TryParse for ListComponentsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (keymaps, remaining) =
            crate::x11_utils::parse_list::<Listing>(remaining, n_keymaps.try_to_usize()?)?;
        let (keycodes, remaining) =
            crate::x11_utils::parse_list::<Listing>(remaining, n_keycodes.try_to_usize()?)?;
        let (types, remaining) =
            crate::x11_utils::parse_list::<Listing>(remaining, n_types.try_to_usize()?)?;
        let (compat_maps, remaining) =
            crate::x11_utils::parse_list::<Listing>(remaining, n_compat_maps.try_to_usize()?)?;
        let (symbols, remaining) =
            crate::x11_utils::parse_list::<Listing>(remaining, n_symbols.try_to_usize()?)?;
        let (geometries, remaining) =
            crate::x11_utils::parse_list::<Listing>(remaining, n_geometries.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = ListComponentsReply {
            device_id,
            sequence,
            length,
            extra,
...
impl ListComponentsReply {
    ...
    pub fn n_keymaps(&self) -> u16 {
        self.keymaps.len().try_into().unwrap()
    }
    ...
    pub fn n_keycodes(&self) -> u16 {
        self.keycodes.len().try_into().unwrap()
    }
    ...
    pub fn n_compat_maps(&self) -> u16 {
        self.compat_maps.len().try_into().unwrap()
    }
    ...
    pub fn n_geometries(&self) -> u16 {
        self.geometries.len().try_into().unwrap()
    }
}
...
impl GetKbdByNameRepliesTypesMapBitcase3 {
    pub fn try_parse(
        ...
        let (acts_rtrn_acts, remaining) =
            crate::x11_utils::parse_list::<Action>(remaining, total_actions.try_to_usize()?)?;
        let result = GetKbdByNameRepliesTypesMapBitcase3 {
            acts_rtrn_count,
            acts_rtrn_acts,
        };
        Ok((result, remaining))
...
impl GetKbdByNameRepliesTypesMap {
    fn try_parse(
        ...
        let bitcase3 = if switch_expr & u16::from(MapPart::KEY_ACTIONS) != 0 {
            let (bitcase3, new_remaining) = GetKbdByNameRepliesTypesMapBitcase3::try_parse(
                outer_remaining,
                n_key_actions,
                total_actions,
            )?;
        ...
        let result = GetKbdByNameRepliesTypesMap {
            types_rtrn,
            syms_rtrn,
            bitcase3,
            behaviors_rtrn,
...
impl TryParse for GetKbdByNameRepliesTypes {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(1..).ok_or(ParseError::InsufficientData)?;
        let (virtual_mods, remaining) = u16::try_parse(remaining)?;
        let (map, remaining) = GetKbdByNameRepliesTypesMap::try_parse(
            remaining,
            present,
            n_types,
            n_key_syms,
        ...
        let result = GetKbdByNameRepliesTypes {
            getmap_type,
            type_device_id,
            getmap_sequence,
            getmap_length,
...
impl TryParse for GetKbdByNameRepliesCompatMap {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetKbdByNameRepliesCompatMap {
            compatmap_type,
            compat_device_id,
            compatmap_sequence,
            compatmap_length,
...
impl TryParse for GetKbdByNameRepliesIndicatorMaps {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(15..).ok_or(ParseError::InsufficientData)?;
        let (maps, remaining) =
            crate::x11_utils::parse_list::<IndicatorMap>(remaining, n_indicators.try_to_usize()?)?;
        let result = GetKbdByNameRepliesIndicatorMaps {
            indicatormap_type,
            indicator_device_id,
...
impl GetKbdByNameRepliesKeyNamesValueListBitcase8 {
    pub fn try_parse(remaining: &[u8], n_types: u8) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetKbdByNameRepliesKeyNamesValueListBitcase8 {
            n_levels_per_type,
            kt_level_names,
        };
        Ok((result, remaining))
...
impl GetKbdByNameRepliesKeyNamesValueList {
    fn try_parse(
        ...
        let bitcase8 = if switch_expr & u32::from(NameDetail::KT_LEVEL_NAMES) != 0 {
            let (bitcase8, new_remaining) =
                GetKbdByNameRepliesKeyNamesValueListBitcase8::try_parse(outer_remaining, n_types)?;
            outer_remaining = new_remaining;
            Some(bitcase8)
        } else {
            None
        ...
        let result = GetKbdByNameRepliesKeyNamesValueList {
            keycodes_name,
            geometry_name,
            symbols_name,
            phys_symbols_name,
...
impl TryParse for GetKbdByNameRepliesKeyNames {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (n_kt_levels, remaining) = u16::try_parse(remaining)?;
        let remaining = remaining.get(4..).ok_or(ParseError::InsufficientData)?;
        let (value_list, remaining) = GetKbdByNameRepliesKeyNamesValueList::try_parse(
            remaining,
            which,
            n_types,
            indicators,
        ...
        let result = GetKbdByNameRepliesKeyNames {
            keyname_type,
            key_device_id,
            keyname_sequence,
            keyname_length,
...
impl TryParse for GetKbdByNameRepliesGeometry {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetKbdByNameRepliesGeometry {
            geometry_type,
            geometry_device_id,
            geometry_sequence,
            geometry_length,
...
impl GetKbdByNameReplies {
    fn try_parse(value: &[u8], reported: u16) -> Result<(Self, &[u8]), ParseError> {
        ...
        let mut outer_remaining = value;
        let types = if switch_expr & u16::from(GBNDetail::TYPES) != 0
            || switch_expr & u16::from(GBNDetail::CLIENT_SYMBOLS) != 0
            || switch_expr & u16::from(GBNDetail::SERVER_SYMBOLS) != 0
        {
        ...
        let compat_map = if switch_expr & u16::from(GBNDetail::COMPAT_MAP) != 0 {
            let (compat_map, new_remaining) =
                GetKbdByNameRepliesCompatMap::try_parse(outer_remaining)?;
            outer_remaining = new_remaining;
            Some(compat_map)
        } else {
            None
        ...
        let indicator_maps = if switch_expr & u16::from(GBNDetail::INDICATOR_MAPS) != 0 {
            let (indicator_maps, new_remaining) =
                GetKbdByNameRepliesIndicatorMaps::try_parse(outer_remaining)?;
            outer_remaining = new_remaining;
            Some(indicator_maps)
        } else {
            None
        };
        let key_names = if switch_expr & u16::from(GBNDetail::KEY_NAMES) != 0
            || switch_expr & u16::from(GBNDetail::OTHER_NAMES) != 0
        {
            let (key_names, new_remaining) =
                GetKbdByNameRepliesKeyNames::try_parse(outer_remaining)?;
            outer_remaining = new_remaining;
            Some(key_names)
        } else {
            None
        ...
        let geometry = if switch_expr & u16::from(GBNDetail::GEOMETRY) != 0 {
            let (geometry, new_remaining) =
                GetKbdByNameRepliesGeometry::try_parse(outer_remaining)?;
            outer_remaining = new_remaining;
            Some(geometry)
        } else {
            None
        };
        let result = GetKbdByNameReplies {
            types,
            compat_map,
            indicator_maps,
            key_names,
...
impl TryParse for GetDeviceInfoReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (name, remaining) =
            crate::x11_utils::parse_u8_list(remaining, name_len.try_to_usize()?)?;
        ...
        let remaining = remaining
            .get(misalignment..)
            .ok_or(ParseError::InsufficientData)?;
        let (btn_actions, remaining) =
            crate::x11_utils::parse_list::<Action>(remaining, n_btns_rtrn.try_to_usize()?)?;
        let (leds, remaining) = crate::x11_utils::parse_list::<DeviceLedInfo>(
            remaining,
            n_device_led_f_bs.try_to_usize()?,
        )?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetDeviceInfoReply {
            device_id,
            sequence,
            length,
            present,
...
impl GetDeviceInfoReply {
    ...
    pub fn n_btns_rtrn(&self) -> u8 {
        self.btn_actions.len().try_into().unwrap()
    }
...
impl<'input> SetDeviceInfoRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let n_btns =
            u8::try_from(self.btn_actions.len()).expect("`btn_actions` has too many elements");
        let n_btns_bytes = n_btns.serialize();
        let change_bytes = self.change.serialize();
        let n_device_led_f_bs =
            u16::try_from(self.leds.len()).expect("`leds` has too many elements");
        ...
        let referenced: &[u8] = btn_actions_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let leds_bytes = self.leds.serialize();
        let referenced: &[u8] = leds_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(btn_actions_bytes.as_ref());
        request0.extend_from_slice(leds_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl<'input> SetDebuggingFlagsRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        let length_so_far = 0;
        let msg_length =
            u16::try_from(self.message.len()).expect("`message` has too many elements");
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.message.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.message.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for SetDebuggingFlagsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = SetDebuggingFlagsReply {
            sequence,
            length,
            current_flags,
            current_ctrls,
...
impl TryParse for NewKeyboardNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = NewKeyboardNotifyEvent {
            response_type,
            xkb_type,
            sequence,
            time,
...
impl TryParse for ControlsNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (request_minor, remaining) = u8::try_parse(remaining)?;
        let remaining = remaining.get(4..).ok_or(ParseError::InsufficientData)?;
        let result = ControlsNotifyEvent {
            response_type,
            xkb_type,
            sequence,
            time,
...
impl TryParse for IndicatorStateNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = IndicatorStateNotifyEvent {
            response_type,
            xkb_type,
            sequence,
            time,
...
impl TryParse for IndicatorMapNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(12..).ok_or(ParseError::InsufficientData)?;
        let result = IndicatorMapNotifyEvent {
            response_type,
            xkb_type,
            sequence,
            time,
...
impl TryParse for CompatMapNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (n_total_si, remaining) = u16::try_parse(remaining)?;
        let remaining = remaining.get(16..).ok_or(ParseError::InsufficientData)?;
        let result = CompatMapNotifyEvent {
            response_type,
            xkb_type,
            sequence,
            time,
...
impl TryParse for ExtensionDeviceNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(2..).ok_or(ParseError::InsufficientData)?;
        let led_class = led_class.into();
        let result = ExtensionDeviceNotifyEvent {
            response_type,
            xkb_type,
            sequence,
            time,
