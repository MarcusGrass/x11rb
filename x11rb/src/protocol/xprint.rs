...
impl TryParse for Printer {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (description, remaining) =
            crate::x11_utils::parse_u8_list(remaining, desc_len.try_to_usize()?)?;
...
impl Serialize for Printer {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        let desc_len =
            u32::try_from(self.description.len()).expect("`description` has too many elements");
...
impl Printer {
    ...
    pub fn desc_len(&self) -> u32 {
        self.description.len().try_into().unwrap()
    }
}
...
impl core::fmt::Debug for Detail {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::START_JOB_NOTIFY.0.into(),
                "START_JOB_NOTIFY",
                "StartJobNotify",
            ),
            (
                Self::END_JOB_NOTIFY.0.into(),
                "END_JOB_NOTIFY",
                "EndJobNotify",
            ),
            (
                Self::START_DOC_NOTIFY.0.into(),
                "START_DOC_NOTIFY",
                "StartDocNotify",
            ),
            (
                Self::END_DOC_NOTIFY.0.into(),
                "END_DOC_NOTIFY",
                "EndDocNotify",
            ),
            (
                Self::START_PAGE_NOTIFY.0.into(),
                "START_PAGE_NOTIFY",
                "StartPageNotify",
            ),
            (
                Self::END_PAGE_NOTIFY.0.into(),
                "END_PAGE_NOTIFY",
                "EndPageNotify",
            ),
        ];
...
impl PrintQueryVersionRequest {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        let mut request0 = [major_opcode, PRINT_QUERY_VERSION_REQUEST, 0, 0];
...
impl TryParse for PrintQueryVersionReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PrintQueryVersionReply {
            sequence,
            length,
            major_version,
            minor_version,
...
impl<'input> PrintGetPrinterListRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let printer_name_len =
            u32::try_from(self.printer_name.len()).expect("`printer_name` has too many elements");
        ...
        let referenced: &[u8] = self.printer_name.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let referenced: &[u8] = self.locale.as_ref();
        let length_so_far = length_so_far + referenced.len();
        ...
        request0.extend_from_slice(self.printer_name.as_ref());
        request0.extend_from_slice(self.locale.as_ref());
...
impl TryParse for PrintGetPrinterListReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (printers, remaining) =
            crate::x11_utils::parse_list::<Printer>(remaining, list_count.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = PrintGetPrinterListReply {
            sequence,
            length,
            printers,
        };
...
impl PrintGetPrinterListReply {
    ...
    pub fn list_count(&self) -> u32 {
        self.printers.len().try_into().unwrap()
    }
}
...
impl PrintRehashPrinterListRequest {
    ...
    #[must_use]
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        let mut request0 = [major_opcode, PRINT_REHASH_PRINTER_LIST_REQUEST, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl PrintGetContextRequest {
    ...
    #[must_use]
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        let mut request0 = [major_opcode, PRINT_GET_CONTEXT_REQUEST, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl PrintGetScreenOfContextRequest {
    ...
    #[must_use]
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        let mut request0 = [major_opcode, PRINT_GET_SCREEN_OF_CONTEXT_REQUEST, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for PrintGetScreenOfContextReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PrintGetScreenOfContextReply {
            sequence,
            length,
            root,
        };
...
impl<'input> PrintPutDocumentDataRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let len_fmt =
            u16::try_from(self.doc_format.len()).expect("`doc_format` has too many elements");
        let len_fmt_bytes = len_fmt.serialize();
        let len_options =
            u16::try_from(self.options.len()).expect("`options` has too many elements");
        ...
        let length_so_far = length_so_far + referenced.len();
        let referenced: &[u8] = self.doc_format.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let referenced: &[u8] = self.options.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        ...
        request0.extend_from_slice(self.doc_format.as_ref());
        request0.extend_from_slice(self.options.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for PrintGetDocumentDataReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (data, remaining) =
            crate::x11_utils::parse_u8_list(remaining, data_len.try_to_usize()?)?;
        let data = data.to_vec();
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = PrintGetDocumentDataReply {
            sequence,
            length,
            status_code,
            finished_flag,
...
impl TryParse for PrintInputSelectedReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PrintInputSelectedReply {
            sequence,
            length,
            event_mask,
            all_events_mask,
...
impl TryParse for PrintGetAttributesReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (attributes, remaining) =
            crate::x11_utils::parse_u8_list(remaining, string_len.try_to_usize()?)?;
        let attributes = attributes.to_vec();
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = PrintGetAttributesReply {
            sequence,
            length,
            attributes,
        };
...
impl TryParse for PrintGetOneAttributesReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(20..).ok_or(ParseError::InsufficientData)?;
        let (value, remaining) =
            crate::x11_utils::parse_u8_list(remaining, value_len.try_to_usize()?)?;
        let value = value.to_vec();
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = PrintGetOneAttributesReply {
            sequence,
            length,
            value,
        };
...
impl<'input> PrintSetAttributesRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.attributes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.attributes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for PrintGetPageDimensionsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PrintGetPageDimensionsReply {
            sequence,
            length,
            width,
            height,
...
impl PrintQueryScreensRequest {
    ...
    #[must_use]
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        let mut request0 = [major_opcode, PRINT_QUERY_SCREENS_REQUEST, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for PrintQueryScreensReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(20..).ok_or(ParseError::InsufficientData)?;
        let (roots, remaining) =
            crate::x11_utils::parse_list::<xproto::Window>(remaining, list_count.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
...
impl TryParse for PrintSetImageResolutionReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PrintSetImageResolutionReply {
            status,
            sequence,
            length,
...
impl TryParse for PrintGetImageResolutionReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PrintGetImageResolutionReply {
            sequence,
            length,
            image_resolution,
        };
...
impl TryParse for AttributNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (sequence, remaining) = u16::try_parse(remaining)?;
        let (context, remaining) = Pcontext::try_parse(remaining)?;
        let result = AttributNotifyEvent {
            response_type,
            detail,
            sequence,
            context,
