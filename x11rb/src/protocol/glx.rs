...
impl TryParse for PbufferClobberEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = PbufferClobberEvent {
            response_type,
            sequence,
            event_type,
            draw_type,
...
impl GetVisualConfigsReply {
    ...
    pub fn length(&self) -> u32 {
        self.property_list.len().try_into().unwrap()
    }
}
...
impl TryParse for VendorPrivateWithReplyReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (data2, remaining) = crate::x11_utils::parse_u8_list(
            remaining,
            length
                .checked_mul(4u32)
        ...
        let result = VendorPrivateWithReplyReply {
            sequence,
            retval,
            data1,
            data2,
...
impl VendorPrivateWithReplyReply {
    ...
    #[must_use]
    pub fn length(&self) -> u32 {
        self.data2.len().checked_div(4).unwrap().try_into().unwrap()
    }
}
...
impl TryParse for QueryExtensionsStringReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = QueryExtensionsStringReply {
            sequence,
            length,
            n,
        };
...
impl TryParse for QueryServerStringReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (string, remaining) =
            crate::x11_utils::parse_u8_list(remaining, str_len.try_to_usize()?)?;
        let string = string.to_vec();
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = QueryServerStringReply {
            sequence,
            length,
            string,
        };
...
impl<'input> CreatePixmapRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        debug_assert_eq!(
            self.attribs.len() % 2,
            0,
            "`attribs` has an incorrect length, must be a multiple of 2"
        );
        let num_attribs =
            u32::try_from(self.attribs.len() / 2).expect("`attribs` has too many elements");
        ...
        let referenced: &[u8] = attribs_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(attribs_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for QueryContextReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(20..).ok_or(ParseError::InsufficientData)?;
        let (attribs, remaining) = crate::x11_utils::parse_list::<u32>(
            remaining,
            num_attribs
                .checked_mul(2u32)
                .ok_or(ParseError::InvalidExpression)?
...
impl TryParse for MakeContextCurrentReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = MakeContextCurrentReply {
            sequence,
            length,
            context_tag,
        };
...
impl<'input> SetClientInfoARBRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let minor_version_bytes = self.minor_version.serialize();
        debug_assert_eq!(
            self.gl_versions.len() % 2,
            0,
            "`gl_versions` has an incorrect length, must be a multiple of 2"
        );
        let num_versions =
            u32::try_from(self.gl_versions.len() / 2).expect("`gl_versions` has too many elements");
        let num_versions_bytes = num_versions.serialize();
        let gl_str_len = u32::try_from(self.gl_extension_string.len())
            .expect("`gl_extension_string` has too many elements");
        let gl_str_len_bytes = gl_str_len.serialize();
        let glx_str_len = u32::try_from(self.glx_extension_string.len())
            .expect("`glx_extension_string` has too many elements");
        ...
        let referenced: &[u8] = gl_versions_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let referenced: &[u8] = self.gl_extension_string.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let referenced: &[u8] = self.glx_extension_string.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(gl_versions_bytes.as_ref());
        request0.extend_from_slice(self.gl_extension_string.as_ref());
        request0.extend_from_slice(self.glx_extension_string.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl<'input> SetClientInfo2ARBRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let minor_version_bytes = self.minor_version.serialize();
        debug_assert_eq!(
            self.gl_versions.len() % 3,
            0,
            "`gl_versions` has an incorrect length, must be a multiple of 3"
        );
        let num_versions =
            u32::try_from(self.gl_versions.len() / 3).expect("`gl_versions` has too many elements");
        let num_versions_bytes = num_versions.serialize();
        let gl_str_len = u32::try_from(self.gl_extension_string.len())
            .expect("`gl_extension_string` has too many elements");
        let gl_str_len_bytes = gl_str_len.serialize();
...
impl TryParse for GetClipPlaneReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (length, remaining) = u32::try_parse(remaining)?;
        let remaining = remaining.get(24..).ok_or(ParseError::InsufficientData)?;
        let (data, remaining) = crate::x11_utils::parse_list::<Float64>(
            remaining,
            length
                .checked_div(2u32)
                .ok_or(ParseError::InvalidExpression)?
...
impl GetClipPlaneReply {
    ...
    #[must_use]
    pub fn length(&self) -> u32 {
        self.data.len().checked_mul(2).unwrap().try_into().unwrap()
    }
}
...
impl TryParse for GetDoublevReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (data, remaining) =
            crate::x11_utils::parse_list::<Float64>(remaining, n.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetDoublevReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetFloatvReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(12..).ok_or(ParseError::InsufficientData)?;
        let (data, remaining) =
            crate::x11_utils::parse_list::<Float32>(remaining, n.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetFloatvReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetPixelMapuivReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetPixelMapuivReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetPixelMapusvReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetPixelMapusvReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetTexParameterfvReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetTexParameterfvReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetTexLevelParameterfvReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetTexLevelParameterfvReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetTexLevelParameterivReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetTexLevelParameterivReply {
            sequence,
            length,
            datum,
            data,
...
impl<'input> AreTexturesResidentRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = textures_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(textures_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for AreTexturesResidentReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (ret_val, remaining) = Bool32::try_parse(remaining)?;
        let remaining = remaining.get(20..).ok_or(ParseError::InsufficientData)?;
        let (data, remaining) = crate::x11_utils::parse_list::<bool>(
            remaining,
            length
                .checked_mul(4u32)
                .ok_or(ParseError::InvalidExpression)?
        ...
        let result = AreTexturesResidentReply {
            sequence,
            ret_val,
            data,
        };
...
impl TryParse for GetConvolutionFilterReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetConvolutionFilterReply {
            sequence,
            width,
            height,
            data,
...
impl TryParse for GetConvolutionParameterfvReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetConvolutionParameterfvReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetSeparableFilterReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(8..).ok_or(ParseError::InsufficientData)?;
        let (rows_and_cols, remaining) = crate::x11_utils::parse_u8_list(
            remaining,
            length
                .checked_mul(4u32)
                .ok_or(ParseError::InvalidExpression)?
        ...
        let result = GetSeparableFilterReply {
            sequence,
            row_w,
            col_h,
            rows_and_cols,
...
impl TryParse for GetHistogramParameterfvReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetHistogramParameterfvReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetHistogramParameterivReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetHistogramParameterivReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetMinmaxParameterivReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetMinmaxParameterivReply {
            sequence,
            length,
            datum,
            data,
...
impl TryParse for GetCompressedTexImageARBReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetCompressedTexImageARBReply {
            sequence,
            size,
            data,
        };
...
impl<'input> DeleteQueriesARBRequest<'input> {
    ...
    pub fn serialize(self, major_opcode: u8) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = ids_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(ids_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for GetQueryObjectuivARBReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetQueryObjectuivARBReply {
            sequence,
            length,
            datum,
            data,
