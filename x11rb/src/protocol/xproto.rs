...
impl TryParse for Depth {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (visuals, remaining) =
            crate::x11_utils::parse_list::<Visualtype>(remaining, visuals_len.try_to_usize()?)?;
...
crate::bitmask_binop!(EventMask, u32);
...
impl TryParse for Screen {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (allowed_depths, remaining) =
            crate::x11_utils::parse_list::<Depth>(remaining, allowed_depths_len.try_to_usize()?)?;
...
impl Serialize for Screen {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        let allowed_depths_len = u8::try_from(self.allowed_depths.len())
            .expect("`allowed_depths` has too many elements");
...
impl Screen {
    ...
    pub fn allowed_depths_len(&self) -> u8 {
        self.allowed_depths.len().try_into().unwrap()
    }
}
...
impl TryParse for SetupRequest {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (authorization_protocol_name, remaining) = crate::x11_utils::parse_u8_list(
            remaining,
            authorization_protocol_name_len.try_to_usize()?,
        )?;
        ...
        let (authorization_protocol_data, remaining) = crate::x11_utils::parse_u8_list(
            remaining,
            authorization_protocol_data_len.try_to_usize()?,
        )?;
...
impl Serialize for SetupRequest {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        let authorization_protocol_name_len = u16::try_from(self.authorization_protocol_name.len())
            .expect("`authorization_protocol_name` has too many elements");
        ...
        let authorization_protocol_data_len = u16::try_from(self.authorization_protocol_data.len())
            .expect("`authorization_protocol_data` has too many elements");
...
impl SetupRequest {
    ...
    pub fn authorization_protocol_name_len(&self) -> u16 {
        self.authorization_protocol_name.len().try_into().unwrap()
    }
    ...
    pub fn authorization_protocol_data_len(&self) -> u16 {
        self.authorization_protocol_data.len().try_into().unwrap()
    }
}
...
impl TryParse for SetupFailed {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (reason, remaining) =
            crate::x11_utils::parse_u8_list(remaining, reason_len.try_to_usize()?)?;
        let reason = reason.to_vec();
        let result = SetupFailed {
            status,
            protocol_major_version,
            protocol_minor_version,
            length,
...
impl SetupFailed {
    ...
    pub fn reason_len(&self) -> u8 {
        self.reason.len().try_into().unwrap()
    }
}
...
impl Serialize for SetupAuthenticate {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        debug_assert_eq!(
            self.reason.len() % 4,
            0,
            "`reason` has an incorrect length, must be a multiple of 4"
        );
...
impl TryParse for Setup {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (vendor, remaining) =
            crate::x11_utils::parse_u8_list(remaining, vendor_len.try_to_usize()?)?;
        ...
        let remaining = remaining
            .get(misalignment..)
            .ok_or(ParseError::InsufficientData)?;
        let (pixmap_formats, remaining) =
            crate::x11_utils::parse_list::<Format>(remaining, pixmap_formats_len.try_to_usize()?)?;
        let (roots, remaining) =
            crate::x11_utils::parse_list::<Screen>(remaining, roots_len.try_to_usize()?)?;
...
impl Serialize for Setup {
    ...
    fn serialize_into(&self, bytes: &mut Vec<u8>) {
        ...
        let pixmap_formats_len = u8::try_from(self.pixmap_formats.len())
            .expect("`pixmap_formats` has too many elements");
...
impl Setup {
    ...
    pub fn vendor_len(&self) -> u16 {
        self.vendor.len().try_into().unwrap()
    }
    ...
    pub fn roots_len(&self) -> u8 {
        self.roots.len().try_into().unwrap()
    }
    ...
    pub fn pixmap_formats_len(&self) -> u8 {
        self.pixmap_formats.len().try_into().unwrap()
    }
}
...
crate::bitmask_binop!(ModMask, u16);
...
crate::bitmask_binop!(KeyButMask, u16);
...
crate::bitmask_binop!(ButtonMask, u16);
...
impl TryParse for GraphicsExposureEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(3..).ok_or(ParseError::InsufficientData)?;
        let result = GraphicsExposureEvent {
            response_type,
            sequence,
            drawable,
            x,
...
impl core::fmt::Debug for Visibility {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::PARTIALLY_OBSCURED.0.into(),
                "PARTIALLY_OBSCURED",
                "PartiallyObscured",
            ),
            (
                Self::FULLY_OBSCURED.0.into(),
                "FULLY_OBSCURED",
                "FullyObscured",
            ),
        ];
...
impl TryParse for VisibilityNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = VisibilityNotifyEvent {
            response_type,
            sequence,
            window,
            state,
...
impl TryParse for ReparentNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (override_redirect, remaining) = bool::try_parse(remaining)?;
        let remaining = remaining.get(3..).ok_or(ParseError::InsufficientData)?;
        let result = ReparentNotifyEvent {
            response_type,
            sequence,
            event,
            window,
...
impl TryParse for ConfigureRequestEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = ConfigureRequestEvent {
            response_type,
            stack_mode,
            sequence,
            parent,
...
impl TryParse for CirculateNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = CirculateNotifyEvent {
            response_type,
            sequence,
            event,
            window,
...
impl TryParse for PropertyNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(3..).ok_or(ParseError::InsufficientData)?;
        let state = state.into();
        let result = PropertyNotifyEvent {
            response_type,
            sequence,
            window,
            atom,
...
impl core::fmt::Debug for Time {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [(Self::CURRENT_TIME.0.into(), "CURRENT_TIME", "CurrentTime")];
        pretty_print_enum(fmt, self.0.into(), &variants)
    }
}
...
impl core::fmt::Debug for AtomEnum {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::RESOURCE_MANAGER.0.into(),
                "RESOURCE_MANAGER",
                "RESOURCE_MANAGER",
            ),
            (
                Self::RGB_COLOR_MAP.0.into(),
                "RGB_COLOR_MAP",
                "RGB_COLOR_MAP",
            ),
            ...
            (
                Self::RGB_DEFAULT_MAP.0.into(),
                "RGB_DEFAULT_MAP",
                "RGB_DEFAULT_MAP",
            ),
            (Self::RGB_GRAY_MAP.0.into(), "RGB_GRAY_MAP", "RGB_GRAY_MAP"),
            (
                Self::RGB_GREEN_MAP.0.into(),
                "RGB_GREEN_MAP",
                "RGB_GREEN_MAP",
            ),
            ...
            (
                Self::WM_NORMAL_HINTS.0.into(),
                "WM_NORMAL_HINTS",
                "WM_NORMAL_HINTS",
            ),
            (
                Self::WM_SIZE_HINTS.0.into(),
                "WM_SIZE_HINTS",
                "WM_SIZE_HINTS",
            ),
            (
                Self::WM_ZOOM_HINTS.0.into(),
                "WM_ZOOM_HINTS",
                "WM_ZOOM_HINTS",
            ),
            ...
            (
                Self::SUPERSCRIPT_X.0.into(),
                "SUPERSCRIPT_X",
                "SUPERSCRIPT_X",
            ),
            (
                Self::SUPERSCRIPT_Y.0.into(),
                "SUPERSCRIPT_Y",
                "SUPERSCRIPT_Y",
            ),
            ...
            (
                Self::UNDERLINE_POSITION.0.into(),
                "UNDERLINE_POSITION",
                "UNDERLINE_POSITION",
            ),
            (
                Self::UNDERLINE_THICKNESS.0.into(),
                "UNDERLINE_THICKNESS",
                "UNDERLINE_THICKNESS",
            ),
            (
                Self::STRIKEOUT_ASCENT.0.into(),
                "STRIKEOUT_ASCENT",
                "STRIKEOUT_ASCENT",
            ),
            (
                Self::STRIKEOUT_DESCENT.0.into(),
                "STRIKEOUT_DESCENT",
                "STRIKEOUT_DESCENT",
            ),
...
impl TryParse for SelectionRequestEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = SelectionRequestEvent {
            response_type,
            sequence,
            time,
            owner,
...
impl TryParse for SelectionNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (target, remaining) = Atom::try_parse(remaining)?;
        let (property, remaining) = Atom::try_parse(remaining)?;
        let result = SelectionNotifyEvent {
            response_type,
            sequence,
            time,
            requestor,
...
impl TryParse for ColormapNotifyEvent {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(2..).ok_or(ParseError::InsufficientData)?;
        let state = state.into();
        let result = ColormapNotifyEvent {
            response_type,
            sequence,
            window,
            colormap,
...
impl ClientMessageData {
    ...
    pub fn as_data16(&self) -> [u16; 10] {
        fn do_the_parse(remaining: &[u8]) -> Result<[u16; 10], ParseError> {
            ...
            let data16 = [
                data16_0, data16_1, data16_2, data16_3, data16_4, data16_5, data16_6, data16_7,
                data16_8, data16_9,
            ];
            let _ = remaining;
            Ok(data16)
    ...
    pub fn as_data32(&self) -> [u32; 5] {
        fn do_the_parse(remaining: &[u8]) -> Result<[u32; 5], ParseError> {
            ...
            let data32 = [data32_0, data32_1, data32_2, data32_3, data32_4];
            let _ = remaining;
            Ok(data32)
        }
        do_the_parse(&self.0).unwrap()
...
impl core::fmt::Debug for CW {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::BACKING_STORE.0.into(),
                "BACKING_STORE",
                "BackingStore",
            ),
            (
                Self::BACKING_PLANES.0.into(),
                "BACKING_PLANES",
                "BackingPlanes",
            ),
            (
                Self::BACKING_PIXEL.0.into(),
                "BACKING_PIXEL",
                "BackingPixel",
            ),
            (
                Self::OVERRIDE_REDIRECT.0.into(),
                "OVERRIDE_REDIRECT",
                "OverrideRedirect",
            ),
...
impl TryParse for GetWindowAttributesReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetWindowAttributesReply {
            backing_store,
            sequence,
            length,
            visual,
...
crate::bitmask_binop!(ConfigWindow, u8);
...
impl ConfigureWindowAux {
    #[allow(dead_code)]
    fn serialize(&self, value_mask: u16) -> impl AsRef<[u8]> {
        let mut result = Vec::new();
        self.serialize_into(&mut result, value_mask);
        result
    }
...
impl ConfigureWindowAux {
    ...
    #[must_use]
    pub fn x<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
        self.x = value.into();
    ...
    #[must_use]
    pub fn y<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
        self.y = value.into();
    ...
    #[must_use]
    pub fn width<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn height<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn border_width<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn sibling<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn stack_mode<I>(mut self, value: I) -> Self
    where
...
impl TryParse for QueryTreeReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (children, remaining) =
            crate::x11_utils::parse_list::<Window>(remaining, children_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = QueryTreeReply {
            sequence,
            length,
            root,
            parent,
...
impl<'input> ChangePropertyRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        debug_assert_eq!(
            ...
            usize::try_from(
                self.data_len
                    .checked_mul(u32::from(self.format))
                    .unwrap()
                    .checked_div(8u32)
                    .unwrap()
            )
            .unwrap(),
            "`data` has an incorrect length"
        );
...
impl GetPropertyReply {
    ...
    /// debug_assert_eq!(iter.next(), Some(257));
    /// debug_assert_eq!(iter.next(), Some(514));
    /// debug_assert_eq!(iter.next(), None);
    /// ```
    ///
    /// An iterator is only returned when the `format` is correct.
    ...
    /// debug_assert_eq!(iter.next(), Some(16908801));
    /// debug_assert_eq!(iter.next(), None);
    /// ```
    ///
    /// An iterator is only returned when the `format` is correct.
...
impl TryParse for GetPropertyReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (value, remaining) = crate::x11_utils::parse_u8_list(
            remaining,
            value_len
                .checked_mul(
                    u32::from(format)
...
impl TryParse for ListPropertiesReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(22..).ok_or(ParseError::InsufficientData)?;
        let (atoms, remaining) =
            crate::x11_utils::parse_list::<Atom>(remaining, atoms_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
...
impl TryParse for GetSelectionOwnerReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetSelectionOwnerReply {
            sequence,
            length,
            owner,
        };
...
impl<'input> SendEventRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let event_bytes = self.event.as_ref();
        let mut request0 = [
            SEND_EVENT_REQUEST,
            propagate_bytes[0],
            0,
...
impl core::fmt::Debug for Allow {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::ASYNC_POINTER.0.into(),
                "ASYNC_POINTER",
                "AsyncPointer",
            ),
            (Self::SYNC_POINTER.0.into(), "SYNC_POINTER", "SyncPointer"),
            (
                Self::REPLAY_POINTER.0.into(),
                "REPLAY_POINTER",
                "ReplayPointer",
            ),
            (
                Self::ASYNC_KEYBOARD.0.into(),
                "ASYNC_KEYBOARD",
                "AsyncKeyboard",
            ),
            (
                Self::SYNC_KEYBOARD.0.into(),
                "SYNC_KEYBOARD",
                "SyncKeyboard",
            ),
            (
                Self::REPLAY_KEYBOARD.0.into(),
                "REPLAY_KEYBOARD",
                "ReplayKeyboard",
            ),
...
impl GrabServerRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GRAB_SERVER_REQUEST, 0, 0, 0];
...
impl UngrabServerRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [UNGRAB_SERVER_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for GetMotionEventsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (events, remaining) =
            crate::x11_utils::parse_list::<Timecoord>(remaining, events_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetMotionEventsReply {
            sequence,
            length,
            events,
        };
...
impl TryParse for TranslateCoordinatesReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = TranslateCoordinatesReply {
            same_screen,
            sequence,
            length,
            child,
...
impl GetInputFocusRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GET_INPUT_FOCUS_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl QueryKeymapRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [QUERY_KEYMAP_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for QueryFontReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (properties, remaining) =
            crate::x11_utils::parse_list::<Fontprop>(remaining, properties_len.try_to_usize()?)?;
        let (char_infos, remaining) =
            crate::x11_utils::parse_list::<Charinfo>(remaining, char_infos_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let draw_direction = draw_direction.into();
        let result = QueryFontReply {
            sequence,
            length,
            min_bounds,
            max_bounds,
...
impl QueryFontReply {
    ...
    pub fn char_infos_len(&self) -> u32 {
        self.char_infos.len().try_into().unwrap()
    }
}
...
impl<'input> QueryTextExtentsRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = string_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(string_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for QueryTextExtentsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let draw_direction = draw_direction.into();
        let result = QueryTextExtentsReply {
            draw_direction,
            sequence,
            length,
            font_ascent,
...
impl<'input> ListFontsRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let pattern_len =
            u16::try_from(self.pattern.len()).expect("`pattern` has too many elements");
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.pattern.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.pattern.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for ListFontsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(22..).ok_or(ParseError::InsufficientData)?;
        let (names, remaining) =
            crate::x11_utils::parse_list::<Str>(remaining, names_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = ListFontsReply {
            sequence,
            length,
            names,
        };
...
impl TryParse for ListFontsWithInfoReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let draw_direction = draw_direction.into();
        let result = ListFontsWithInfoReply {
            sequence,
            length,
            min_bounds,
            max_bounds,
...
impl<'input> SetFontPathRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let length_so_far = length_so_far + request0.len();
        let font_bytes = self.font.serialize();
        let referenced: &[u8] = font_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(font_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl GetFontPathRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GET_FONT_PATH_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for GetFontPathReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(22..).ok_or(ParseError::InsufficientData)?;
        let (path, remaining) =
            crate::x11_utils::parse_list::<Str>(remaining, path_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetFontPathReply {
            sequence,
            length,
            path,
        };
...
impl CreateGCAux {
    ...
    #[must_use]
    pub fn function<I>(mut self, value: I) -> Self
    where
        I: Into<Option<GX>>,
    {
    ...
    #[must_use]
    pub fn plane_mask<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn foreground<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn background<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn line_width<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn line_style<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn cap_style<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn join_style<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn fill_style<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn fill_rule<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn tile<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Pixmap>>,
    {
    ...
    #[must_use]
    pub fn stipple<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Pixmap>>,
    {
    ...
    #[must_use]
    pub fn tile_stipple_x_origin<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn tile_stipple_y_origin<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn font<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Font>>,
    {
    ...
    #[must_use]
    pub fn subwindow_mode<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn graphics_exposures<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Bool32>>,
    {
    ...
    #[must_use]
    pub fn clip_x_origin<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn clip_y_origin<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn clip_mask<I>(mut self, value: I) -> Self
    where
        I: Into<Option<Pixmap>>,
    {
    ...
    #[must_use]
    pub fn dash_offset<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn dashes<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
    ...
    #[must_use]
    pub fn arc_mode<I>(mut self, value: I) -> Self
    where
        I: Into<Option<ArcMode>>,
    {
...
impl<'input> SetDashesRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.dashes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.dashes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl<'input> PolySegmentRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = segments_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(segments_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl<'input> PolyArcRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = arcs_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(arcs_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl GetImageReply {
    ...
    pub fn length(&self) -> u32 {
        self.data.len().checked_div(4).unwrap().try_into().unwrap()
    }
}
...
impl<'input> PolyText8Request<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.items.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.items.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl<'input> ImageText8Request<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.string.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.string.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for ListInstalledColormapsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(22..).ok_or(ParseError::InsufficientData)?;
        let (cmaps, remaining) =
            crate::x11_utils::parse_list::<Colormap>(remaining, cmaps_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = ListInstalledColormapsReply {
            sequence,
            length,
            cmaps,
        };
...
impl ListInstalledColormapsReply {
    ...
    pub fn cmaps_len(&self) -> u16 {
        self.cmaps.len().try_into().unwrap()
    }
}
...
impl TryParse for AllocNamedColorReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = AllocNamedColorReply {
            sequence,
            length,
            pixel,
            exact_red,
...
impl TryParse for AllocColorCellsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(20..).ok_or(ParseError::InsufficientData)?;
        let (pixels, remaining) =
            crate::x11_utils::parse_list::<u32>(remaining, pixels_len.try_to_usize()?)?;
        let (masks, remaining) =
            crate::x11_utils::parse_list::<u32>(remaining, masks_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = AllocColorCellsReply {
            sequence,
            length,
            pixels,
            masks,
...
impl TryParse for AllocColorPlanesReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = AllocColorPlanesReply {
            sequence,
            length,
            red_mask,
            green_mask,
...
impl<'input> FreeColorsRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = pixels_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(pixels_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
crate::bitmask_binop!(ColorFlag, u8);
...
impl TryParse for QueryColorsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (colors, remaining) =
            crate::x11_utils::parse_list::<Rgb>(remaining, colors_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = QueryColorsReply {
            sequence,
            length,
            colors,
        };
...
impl core::fmt::Debug for QueryShapeOf {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            (
                Self::LARGEST_CURSOR.0.into(),
                "LARGEST_CURSOR",
                "LargestCursor",
            ),
            (Self::FASTEST_TILE.0.into(), "FASTEST_TILE", "FastestTile"),
            (
                Self::FASTEST_STIPPLE.0.into(),
                "FASTEST_STIPPLE",
                "FastestStipple",
            ),
        ];
...
impl ListExtensionsRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [LIST_EXTENSIONS_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for ListExtensionsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = ListExtensionsReply {
            sequence,
            length,
            names,
        };
...
impl TryParse for GetKeyboardMappingReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (keysyms, remaining) =
            crate::x11_utils::parse_list::<Keysym>(remaining, length.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let result = GetKeyboardMappingReply {
            keysyms_per_keycode,
            sequence,
            keysyms,
        };
...
impl core::fmt::Debug for LedMode {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [(Self::OFF.0, "OFF", "Off"), (Self::ON.0, "ON", "On")];
        pretty_print_enum(fmt, self.0, &variants)
    }
}
...
impl ChangeKeyboardControlAux {
    ...
    #[must_use]
    pub fn key_click_percent<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn bell_percent<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn bell_pitch<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn bell_duration<I>(mut self, value: I) -> Self
    where
        I: Into<Option<i32>>,
    {
    ...
    #[must_use]
    pub fn led<I>(mut self, value: I) -> Self
    where
        I: Into<Option<u32>>,
    {
        self.led = value.into();
    ...
    #[must_use]
    pub fn led_mode<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn key<I>(mut self, value: I) -> Self
    where
    ...
    #[must_use]
    pub fn auto_repeat_mode<I>(mut self, value: I) -> Self
    where
...
impl GetKeyboardControlRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GET_KEYBOARD_CONTROL_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for GetKeyboardControlReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetKeyboardControlReply {
            global_auto_repeat,
            sequence,
            length,
            led_mask,
...
impl BellRequest {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let mut request0 = [BELL_REQUEST, percent_bytes[0], 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl GetPointerControlRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GET_POINTER_CONTROL_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for GetPointerControlReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetPointerControlReply {
            sequence,
            length,
...
impl GetScreenSaverRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GET_SCREEN_SAVER_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for GetScreenSaverReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetScreenSaverReply {
            sequence,
            length,
            timeout,
            interval,
...
impl core::fmt::Debug for Family {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::SERVER_INTERPRETED.0.into(),
                "SERVER_INTERPRETED",
                "ServerInterpreted",
            ),
...
impl<'input> ChangeHostsRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let address_len =
            u16::try_from(self.address.len()).expect("`address` has too many elements");
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.address.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.address.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for Host {
    fn try_parse(remaining: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (address, remaining) =
            crate::x11_utils::parse_u8_list(remaining, address_len.try_to_usize()?)?;
...
impl Host {
    ...
    pub fn address_len(&self) -> u16 {
        self.address.len().try_into().unwrap()
    }
}
...
impl ListHostsRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [LIST_HOSTS_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for ListHostsReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let remaining = remaining.get(22..).ok_or(ParseError::InsufficientData)?;
        let (hosts, remaining) =
            crate::x11_utils::parse_list::<Host>(remaining, hosts_len.try_to_usize()?)?;
        if response_type != 1 {
            return Err(ParseError::InvalidValue);
        }
        let mode = mode.into();
        let result = ListHostsReply {
            mode,
            sequence,
            length,
            hosts,
...
impl ListHostsReply {
    ...
    pub fn hosts_len(&self) -> u16 {
        self.hosts.len().try_into().unwrap()
    }
}
...
impl SetAccessControlRequest {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mode_bytes = u8::from(self.mode).serialize();
        let mut request0 = [SET_ACCESS_CONTROL_REQUEST, mode_bytes[0], 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl core::fmt::Debug for CloseDown {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        let variants = [
            ...
            (
                Self::RETAIN_PERMANENT.0.into(),
                "RETAIN_PERMANENT",
                "RetainPermanent",
            ),
            (
                Self::RETAIN_TEMPORARY.0.into(),
                "RETAIN_TEMPORARY",
                "RetainTemporary",
            ),
        ];
...
impl SetCloseDownModeRequest {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mode_bytes = u8::from(self.mode).serialize();
        let mut request0 = [SET_CLOSE_DOWN_MODE_REQUEST, mode_bytes[0], 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl<'input> RotatePropertiesRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let referenced: &[u8] = atoms_bytes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(atoms_bytes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl ForceScreenSaverRequest {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mode_bytes = u8::from(self.mode).serialize();
        let mut request0 = [FORCE_SCREEN_SAVER_REQUEST, mode_bytes[0], 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl<'input> SetPointerMappingRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        let mut request0 = vec![SET_POINTER_MAPPING_REQUEST, map_len_bytes[0], 0, 0];
        let length_so_far = length_so_far + request0.len();
...
impl TryParse for SetPointerMappingReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let status = status.into();
        let result = SetPointerMappingReply {
            status,
            sequence,
            length,
        };
...
impl GetPointerMappingRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GET_POINTER_MAPPING_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for GetPointerMappingReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let result = GetPointerMappingReply {
            sequence,
            length,
            map,
        };
...
impl<'input> SetModifierMappingRequest<'input> {
    ...
    pub fn serialize(self) -> impl AsRef<[u8]> {
        ...
        debug_assert_eq!(
            self.keycodes.len() % 8,
            0,
            "`keycodes` has an incorrect length, must be a multiple of 8"
        );
        let keycodes_per_modifier =
            u8::try_from(self.keycodes.len() / 8).expect("`keycodes` has too many elements");
        ...
        let length_so_far = length_so_far + request0.len();
        let referenced: &[u8] = self.keycodes.as_ref();
        let length_so_far = length_so_far + referenced.len();
        let padding0 = &[0; 3][..(4 - (length_so_far % 4)) % 4];
        let length_so_far = length_so_far + padding0.len();
        debug_assert_eq!(0, length_so_far % 4);
        let length = u16::try_from(length_so_far / 4).unwrap_or(0);
        request0[2..4].copy_from_slice(&length.to_ne_bytes());
        request0.extend_from_slice(self.keycodes.as_ref());
        request0.extend_from_slice(padding0.as_ref());
        request0
    }
}
...
impl TryParse for SetModifierMappingReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let status = status.into();
        let result = SetModifierMappingReply {
            status,
            sequence,
            length,
        };
...
impl GetModifierMappingRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [GET_MODIFIER_MAPPING_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
...
impl TryParse for GetModifierMappingReply {
    fn try_parse(initial_value: &[u8]) -> Result<(Self, &[u8]), ParseError> {
        ...
        let (length, remaining) = u32::try_parse(remaining)?;
        let remaining = remaining.get(24..).ok_or(ParseError::InsufficientData)?;
        let (keycodes, remaining) = crate::x11_utils::parse_u8_list(
            remaining,
        ...
        let result = GetModifierMappingReply {
            sequence,
            length,
            keycodes,
        };
...
impl NoOperationRequest {
    ...
    #[must_use]
    pub fn serialize(self) -> impl AsRef<[u8]> {
        let mut request0 = [NO_OPERATION_REQUEST, 0, 0, 0];
        request0[2..4].copy_from_slice(&(1u16).to_ne_bytes());
        request0
    }
}
